...
keywords = set(map(lambda x: x.lower(), open('08_banned_title_keywords.txt').read().split()))
print("Keywords:", keywords)

in_lines = 0
out_lines = 0
out_titles = []
with open('07_filtered_by_llm.jsonl') as i, open('08_filtered_search_results.jsonl', 'w') as o, open('08_filtered_search_titles.txt', 'w') as o2, open('08_title_frequencies.txt', 'w') as o3:
    for line in i:
        in_lines += 1
